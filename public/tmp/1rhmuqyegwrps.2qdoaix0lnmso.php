...
" ?>
  ...
  <a href="/viewTickets" type="button" class="btn btn-dark" style="margin: 30px">Go Back</a>
  
  <form method="POST" enctype="multipart/form-data" style="margin-left: 30px;">
      <div class="form-group">
        <label for="personName">New Customer Name</label>
      ...
      <div class="form-group">
          <label for="attractionName">New Attraction Name</label>
      ...
      <div class="form-group">
          <label for="ticketPrice">New Ticket Price</label>
